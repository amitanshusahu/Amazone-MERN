...
exports.buyFromCart = exports.addToCartInput = exports.OrderInput = exports.updateProductInput = exports.createProductInput = exports.loginInput = exports.signupInput = void 0;
...
exports.updateProductInput = zod_1.z.object({
    pid: zod_1.z.string(),
    username: zod_1.z.string(),
    title: zod_1.z.string(),
    description: zod_1.z.string(),
