...
router.post('/updateproduct', middleware_1.protect, ProductController_1.updateProduct);
router.get('/getproducts', middleware_1.protect, ProductController_1.getProducts);
